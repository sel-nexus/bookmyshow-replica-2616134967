  ...
  return (
    <main className="page-shell">
      <header className="site-header">
        <Link className="brand" href="/" aria-label="BookMyShow Replica home">
      ...
      <section className="hero" aria-labelledby="home-heading">
        <div>
          ...
          <p className="hero-copy">
            Sign in with your mobile number and keep your cinema plans close. A simple, secure entry to the BookMyShow Replica experience.
          </p>
          <div className="hero-actions">
            ...
            <Link className="text-link" href="/theatres?movieId=999999">
              Try empty theatre demo
            </Link>
            <span className="text-link">OTP-powered access</span>
          </div>
        </div>
