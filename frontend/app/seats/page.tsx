    ...
    return (
      <main className="welcome">
        <p className="form-error" role="alert">
          Choose a movie and theatre before selecting seats.
        </p>
  ...
  return (
    <main className="page-shell">
      <header className="site-header">
        ...
        <span className="header-note">Step 1 of 2</span>
      </header>
      <section className="welcome" aria-labelledby="seats-heading">
        ...
        <div className="focal-panel" style={{ marginTop: 36 }}>
          <SeatGrid
            onSelectionChange={(nextSeats, nextTotal) => {
              setSeats(nextSeats);
